...
public class Role {
    ...
    public Role(String name, String description) {
        ...
        if (name == null || name.isBlank()) {
            throw new IllegalArgumentException("Role name cannot empty");
        }
    ...
    public void addPermission(Permission permission) {
        ...
        if (permission == null) {
            throw new IllegalArgumentException("Permission cannot null");
        }
    ...
    public String format() {
         ...
         recap.append("Role: ").append(name).append("[ID: ").append(id).append("]\n");
         recap.append("Description: ").append(description).append("\n");
         recap.append("Permission (").append(permissions.size()).append("):");
